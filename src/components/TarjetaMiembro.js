            ...
            <div className="col-xl-auto col-md-4 col-sm-6 mb-5">
                <div className="bg-white rounded shadow-sm py-5 px-4"><img
                    ...
                    <ul className="social mb-0 list-inline mt-3">
                        <li className="list-inline-item"><a href={this.props.enlace} className="social-link" target="_blank" rel="noreferrer noopener"><i className="fab fa-linkedin-in"></i></a></li>
                    </ul>
                </div>
            </div>
        );
